...
description: Archived Termark release notes for v1.0.47 and earlier.
---

# Changelog Archive

This page contains archived release notes for v1.0.47 and earlier. See the [current changelog](/changelog) for newer releases.
